...
export const systemResetScopes = [
  ...
  { key: 'content', label: 'Store content reset', icon: 'lucide:panels-top-left', description: 'Restore store content and layout to their defaults.', details: ['Store settings, banners, announcements, offers and navigation links.', 'Products, orders, coupons, uploaded files and shipping configuration remain.'], tables: resetTableGroups.content },
