...
import { chatError, chatRouteId, loadChatConversation, loadChatUnreadSummary, readChatJson, requireChatVisitor } from '../../../../utils/liveChat'
...
export default defineEventHandler(async (event) => {
  ...
  const { error } = await actor.supabase.rpc('chat_mark_read', {
    ...
    p_actor_kind: actor.kind, p_sequence: body.sequence
  })
