export const dashboardSettingsSections = [
  ...
  { key: 'layout', section: 'dashboardLayout', label: 'Dashboard layout', group: 'Administration', icon: 'lucide:panel-right', description: 'Use the standard menu or the detailed sidebar.' },
