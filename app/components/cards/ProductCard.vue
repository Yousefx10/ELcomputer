<template>
  <NuxtLink
    ...
    class="group block w-[260px] flex-shrink-0 rounded-2xl border border-gray-200 bg-white p-3 shadow-sm transition hover:-translate-y-1 hover:shadow-md md:w-[280px]"
  >
    ...
    <div class="mt-4 px-1">
      ...
      <h3 class="line-clamp-2 text-base font-semibold leading-6 text-gray-900">
        {{ product.title }}
      </h3>
