<template>
  <aside class="order-first min-w-0 border-b border-gray-200 bg-slate-50 p-5 xl:order-last xl:border-s xl:border-b-0 xl:p-6" aria-label="File details" @keydown.esc.stop="$emit('close')">
